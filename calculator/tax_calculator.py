...
Refactored to use tax_liabilities classes and external calculators.
"""
...
from calculator.state_tax_calculator import calculate_state_income_tax
from calculator.local_tax_calculator import calculate_local_income_tax
...
class BusinessTaxCalculator:
    ...
    def collect_business_info(self):
        ...
        self.business.state = input("State (for state tax estimation): ")
        ...
        self.business.employee_count = int(
    ...
    def collect_deduction_info(self):
        ...
        if self.has_home_office:
            ...
            self.business.home_office_deduction = min(self.home_office_area, 300) * 5
        ...
        if custom_local:
            ...
            self.business.local_tax_rate = rate_pct / 100
    ...
    def calculate_tax_liability(self):
        ...
        # 7. Final SE tax
        self_employment_tax, ss_tax, med_tax = calculate_self_employment_tax(
            self.business, taxable_income
        )
        # 8. State income tax
        state_tax = calculate_state_income_tax(self.business, taxable_income)
        # 9. Local income tax
